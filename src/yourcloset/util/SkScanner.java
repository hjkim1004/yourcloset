...
public class SkScanner {
	...
	// ´ÙÀ½¿¡ getChar()¸¦ ÇßÀ» ¶§ '\r', '\n'ÀÌ ÀĞÇôÁöÁö ¾Ê°Ô ÇÔ
	// ÀÌ ¸Ş¼Òµå´Â ¹İµå½Ã getLong(), getDouble(), getString(), getIndeifier()¸Ş¼ÒµåÀÇ ¸¶¹Ì¸·¿¡¼­
	// È£ÃâµÇ¾î¾ß ÇÔ
	...
	// getLongStringWithoutSkip() : Ç¥ÁØÀÔ·Â¿¡¼­ÀÇ ½ºÅµ¾øÀÌ µğÁöÆ® ¹®ÀÚµé¸¦ ÀĞ¾î String Å¸ÀÔÀÇ °ªÀ¸·Î º¯È¯ÇÏ¿©
	// ¹İÈ¯ÇÏ´Â ¸Ş¼Òµå
	...
	// getTailOfID(int head): Java ½Äº°ÀÚÀÇ ²¿¸®ºÎºĞÀ» ÀÔ·ÂÇÏ¿© ÁÖ¾îÁø Çìµå¹®ÀÚ head¿Í ÇÔ²² ÀüÃ¼ ½Äº°ÀÚ¸¦ ±¸¼ºÇÏ¿©
	// ¹®ÀÚ¿­·Î ¹İÈ¯
	// ½Äº°ÀÚÀÇ Ã¹¹®ÀÚ: ¿µ¹®ÀÚ, ÇÑ±Û, '_', '$'
	// ½Äº°ÀÚÀÇ ²¿¸®ºÎºĞ: ¿µ¹®ÀÚ, ÇÑ±Û, ¼ıÀÚ, '_', '$'
	 ...
	 * 
	 * ÀÔ·ÂÇÒ ¶§ ÇÁ·ÒÇÁÆ® ¸Ş½ÃÁö ¾øÀÌ ÀÔ·ÂÀ» ÇÏ¸é »ç¿ëÀÚ´Â ¸·¿¬È÷ ±â´Ù¸®´Â °æ¿ì°¡ ¹ß»ıÇÑ´Ù. ÀÌ·¯ÇÑ °æ¿ì¸¦ ¹æÁöÇÏ±â À§ÇØ ÀÔ·Â½Ã¿¡´Â ¸Ş½ÃÁö¸¦
	 * ¹Ì¸® Ãâ·ÂÇÏ¿© ÀÔ·ÂÇÒ µ¥ÀÌÅÍÀÇ ¿ëµµ³ª ±â´ÉÀ» ¾Ë·ÁÁÖ´Â ¸Ş½ÃÁö¸¦ ÇÁ·ÒÇÁÆ® ¸Ş½ÃÁö¶ó ÇÑ´Ù.
	 * 
